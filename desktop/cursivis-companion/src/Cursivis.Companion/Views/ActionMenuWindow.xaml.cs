...
public partial class ActionMenuWindow : Window
{
    ...
    public ActionMenuWindow(IReadOnlyList<string> initialActions, IReadOnlyList<string> deferredActions, string contentType)
    {
        ...
        SubtitleText.Text = "Quick actions are ready now. Nova is also generating a few smarter context-aware options.";
    ...
    private async Task AppendDeferredOptionsAsync()
    {
        ...
        ThinkingText.Text = "Nova is thinking...";
        ...
        ThinkingSubtext.Text = "You can keep a quick action, choose one of the new Nova options, or use custom voice.";
    ...
    private static string DescribeAction(string action, bool isContextual)
    {
        ...
        {
            return "This is Nova's current best guess for the most useful next action.";
        }
