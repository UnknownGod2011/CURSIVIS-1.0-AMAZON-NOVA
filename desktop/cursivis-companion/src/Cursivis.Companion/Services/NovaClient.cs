...
public sealed class NovaClient : IDisposable
{
    ...
    private static bool ShouldPreferDraftReply(string text)
    {
        ...
        return EmailHeaderRegex.IsMatch(text) || EmailAddressRegex.IsMatch(text) || LooksLikePolishedEmail(text);
    }
    ...
    private static bool LooksLikeEmail(string text)
    {
        ...
        return EmailRegex.IsMatch(text) || EmailHeaderRegex.IsMatch(text) || EmailAddressRegex.IsMatch(text);
    }
