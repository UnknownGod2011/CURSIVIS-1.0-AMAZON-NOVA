...
if ($Help) {
    Write-Host "Usage:"
    Write-Host "  powershell -ExecutionPolicy Bypass -File .\scripts\deploy-aws.ps1 -AwsAccountId <ID> -AwsAccessKeyId <KEY> -AwsSecretAccessKey <SECRET> [-Region us-east-1] [-ServiceName cursivis-nova-agent]"
    return
}
